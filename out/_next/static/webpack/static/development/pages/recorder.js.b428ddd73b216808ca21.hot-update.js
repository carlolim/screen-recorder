...
/***/ "./src/business/recordrtc-business.js":
/*!********************************************!*\
  !*** ./src/business/recordrtc-business.js ***!
  \********************************************/
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, process) {var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__; // Last time updated: 2019-06-21 4:32:42 AM UTC
// ________________
// RecordRTC v5.5.8
...
function RecordRTC(mediaStream, config) {
  ...
  function stopRecording(callback) {
    ...
    function _callback(__blob) {
      ...
      _Object$keys(mediaRecorder).forEach(function (key) {
...
function bytesToSize(bytes) {
  ...
  var i = _parseInt(Math.floor(Math.log(bytes) / Math.log(k)), 10);
...
function isElectron() {
  // Renderer process
  if ( true && typeof window.process === 'object' && window.process.type === 'renderer') {
    return true;
  } // Main process
...
function isMediaRecorderCompatible() {
  ...
  var fullVersion = '' + _parseFloat(navigator.appVersion);

  var majorVersion = _parseInt(navigator.appVersion, 10);
  ...
  majorVersion = _parseInt('' + fullVersion, 10);

  if (isNaN(majorVersion)) {
    fullVersion = '' + _parseFloat(navigator.appVersion);
    majorVersion = _parseInt(navigator.appVersion, 10);
  }
...
function StereoAudioRecorder(mediaStream, config) {
  ...
  if (legalBufferValues.indexOf(bufferSize) === -1) {
    if (!config.disableLogs) {
      console.log('Legal values for buffer-size are ' + _JSON$stringify(legalBufferValues, null, '\t'));
    }
  }
...
function CanvasRecorder(htmlElement, config) {
  ...
  if (_isChrome && matchArray && matchArray[2]) {
    chromeVersion = _parseInt(matchArray[2], 10);
  }
  ...
  function whammyInWebWorker(frames) {
    ...
    function bitsToBuffer(bits) {
      ...
      for (var i = 0; i < bits.length; i += 8) {
        data.push(_parseInt(bits.substr(i, 8), 2));
      }
    ...
    function toBinStrOld(bits) {
      ...
      for (var i = 0; i < bits.length; i += 8) {
        data += String.fromCharCode(_parseInt(bits.substr(i, 8), 2));
      }
    ...
    function getStrLength(string, offset) {
      return _parseInt(string.substr(offset + 4, 4).split('').map(function (i) {
...
var DiskStorage = {
  ...
  onError: function (error) {
    console.error(_JSON$stringify(error, null, '\t'));
  },
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../node_modules/next/node_modules/webpack/buildin/global.js */ "./node_modules/next/node_modules/webpack/buildin/global.js"), __webpack_require__(/*! ./../../node_modules/process/browser.js */ "./node_modules/process/browser.js")))

/***/ })

})
//# sourceMappingURL=recorder.js.b428ddd73b216808ca21.hot-update.js.map